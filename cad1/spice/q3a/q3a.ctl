...
* Measure
.MEAS DC I1 FIND lx4(m0) WHEN V(vdd!)=0.020
.MEAS DC I2 FIND lx4(m0) WHEN V(vdd!)=0.030
.MEAS resistance_25mV PARAM = '0.01/(I2-I1)'
.MEAS DC I3 FIND lx4(m0) WHEN V(vdd!)=0.245
.MEAS DC I4 FIND lx4(m0) WHEN V(vdd!)=0.255
.MEAS resistance_250mV PARAM = '0.01/(I4-I3)'
